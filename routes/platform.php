...
Route::screen('users/{user}/edit', UserEditScreen::class)
    ...
    ->breadcrumbs(fn (Trail $trail, $user) => $trail->parent('platform.systems.users')->push(__('User'), route('platform.systems.users.edit', $user)));
...
Route::screen('roles/{role}/edit', RoleEditScreen::class)
    ...
    ->breadcrumbs(fn (Trail $trail, $role) => $trail->parent('platform.systems.roles')->push(__('Role'), route('platform.systems.roles.edit', $role)));
